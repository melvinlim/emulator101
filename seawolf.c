...
int main (int argc, char**argv)
{
	...
	ReadFileIntoMemoryAt(state, "sw0041.h", 0);
	ReadFileIntoMemoryAt(state, "sw0042.g", 0x400);
	ReadFileIntoMemoryAt(state, "sw0043.f", 0x800);
	ReadFileIntoMemoryAt(state, "sw0044.e", 0xc00);
